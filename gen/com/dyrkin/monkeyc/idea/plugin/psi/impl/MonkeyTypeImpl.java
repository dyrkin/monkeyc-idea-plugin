...
public class MonkeyTypeImpl extends MonkeyPsiCompositeElementImpl implements MonkeyType {

  public MonkeyTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof MonkeyVisitor) ((MonkeyVisitor)visitor).visitType(this);
