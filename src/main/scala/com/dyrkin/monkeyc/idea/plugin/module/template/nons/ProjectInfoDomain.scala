...
object ProjectInfoDomain {
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  case class Monkeybrains(@xmlElement appPermissions: AppPermissions, @xmlElement permissionMaps: PermissionMaps, @xmlElement appTypes: AppTypes, @xmlElement newProjectFilePlaceholders: NewProjectFilePlaceholders, @xmlElement newProjectFilesMaps: NewProjectFilesMaps) {
